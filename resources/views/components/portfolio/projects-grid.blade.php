<section id="projects" class="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-min grid-flow-dense" id="portfolio-grid">
        ...
        <div data-tilt data-tilt-max="5" data-tilt-speed="400" data-tilt-glare="true" data-tilt-max-glare="0.2" class="project-card lg:col-span-3 bg-gray-900/40 backdrop-blur-sm md:backdrop-blur-xl border border-gray-700/30 rounded-3xl overflow-hidden group hover:shadow-[0_0_40px_rgba(34,211,238,0.15)] transition-all duration-500 flex flex-col md:flex-row relative" data-aos="fade-up" data-aos-delay="100" data-category="web">
            ...
            <div class="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                ...
                <div class="flex flex-wrap gap-4 mt-2">
                    <a href="javascript:void(0)" aria-label="Live Demo" class="px-6 py-3 bg-white text-black rounded-full text-sm font-bold flex items-center gap-2 hover:scale-105 transition-transform shadow-[0_0_15px_rgba(255,255,255,0.2)]">
                        <svg class="parallax-img w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg> Live Demo
                    </a>
            ...
            <div class="md:w-1/2 bg-gray-800/50 relative overflow-hidden flex items-center justify-center p-8">
                ...
                <img loading="lazy" src="{{ asset('images/Project Dapur Riuh.png') }}" alt="Dapur Riuh" class="parallax-img w-[90%] h-auto object-cover rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.6)] group-hover:scale-105 transition-transform duration-700 z-10" onerror="this.src='data:image/svg+xml;charset=UTF-8,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22800%22 height=%22400%22 viewBox=%220 0 800 400%22%3E%3Crect width=%22800%22 height=%22400%22 fill=%22%23e2e8f0%22/%3E%3Ctext x=%22400%22 y=%22200%22 font-family=%22sans-serif%22 font-size=%2224%22 text-anchor=%22middle%22 fill=%22%2394a3b8%22%3EProject Image Placeholder%3C/text%3E%3C/svg%3E'">
            </div>
        </div>

        <!-- Project 2: Indomaret Mobile (Span 1) -->
        <div data-tilt data-tilt-max="5" data-tilt-speed="400" data-tilt-glare="true" data-tilt-max-glare="0.2" class="project-card lg:col-span-1 bg-gray-900/40 backdrop-blur-sm md:backdrop-blur-xl border border-gray-700/30 rounded-3xl overflow-hidden group hover:shadow-[0_0_30px_rgba(34,211,238,0.1)] transition-all duration-500 flex flex-col relative" data-aos="fade-up" data-aos-delay="200" data-category="uiux">
            <div class="h-48 bg-gray-800/50 relative overflow-hidden flex items-end justify-center p-6 pb-0">
                <img loading="lazy" src="{{ asset('images/UiUX Indomaret Mobile.png') }}" alt="Indomaret Mobile" class="parallax-img w-full h-auto object-cover rounded-t-xl shadow-[0_-5px_20px_rgba(0,0,0,0.4)] group-hover:scale-105 transition-transform duration-700">
        ...
        <div data-tilt data-tilt-max="5" data-tilt-speed="400" data-tilt-glare="true" data-tilt-max-glare="0.2" class="project-card lg:col-span-1 bg-gray-900/40 backdrop-blur-sm md:backdrop-blur-xl border border-gray-700/30 rounded-3xl overflow-hidden group hover:shadow-[0_0_30px_rgba(34,211,238,0.1)] transition-all duration-500 flex flex-col relative" data-aos="fade-up" data-aos-delay="300" data-category="uiux">
            <div class="h-48 bg-gray-800/50 relative overflow-hidden flex items-end justify-center p-6 pb-0">
                <img loading="lazy" src="{{ asset('images/UIUX Website Saku Mahasiswa.png') }}" alt="Saku Mahasiswa" class="parallax-img w-full h-auto object-cover rounded-t-xl shadow-[0_-5px_20px_rgba(0,0,0,0.4)] group-hover:scale-105 transition-transform duration-700">
                <div class="absolute inset-0 bg-gray-900/80 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-20">
        ...
        <div data-tilt data-tilt-max="5" data-tilt-speed="400" data-tilt-glare="true" data-tilt-max-glare="0.2" class="project-card lg:col-span-3 bg-gray-900/40 backdrop-blur-sm md:backdrop-blur-xl border border-gray-700/30 rounded-3xl overflow-hidden group hover:shadow-[0_0_30px_rgba(34,211,238,0.1)] transition-all duration-500 flex flex-col md:flex-row relative" data-aos="fade-up" data-aos-delay="400" data-category="uiux">
            ...
            <div class="md:w-1/2 bg-gray-800/50 relative overflow-hidden flex items-center justify-center p-6">
                <img loading="lazy" src="{{ asset('images/Figjam Saku Mahasiswa.png') }}" alt="Figjam Saku Mahasiswa" class="parallax-img w-full h-full object-contain rounded-xl shadow-lg group-hover:scale-105 transition-transform duration-700">
                <div class="absolute inset-0 bg-gray-900/80 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-20">
        ...
        <div data-tilt data-tilt-max="5" data-tilt-speed="400" data-tilt-glare="true" data-tilt-max-glare="0.2" class="project-card lg:col-span-1 bg-gray-900/40 backdrop-blur-sm md:backdrop-blur-xl border border-gray-700/30 rounded-3xl overflow-hidden group hover:shadow-[0_0_30px_rgba(34,211,238,0.1)] transition-all duration-500 flex flex-col relative" data-aos="fade-up" data-aos-delay="500" data-category="uiux">
            <div class="h-48 bg-gray-800/50 relative overflow-hidden flex items-center justify-center p-6">
                <img loading="lazy" src="{{ asset('images/Desain Antarmuka (UI) Sistem Informasi Manajemen Kepegawaian PT Indofood Menggunakan Figma.png') }}" alt="PT Indofood" class="parallax-img w-full h-full object-contain rounded-xl shadow-lg group-hover:scale-105 transition-transform duration-700">
                <div class="absolute inset-0 bg-gray-900/80 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-20">
        ...
        <div data-tilt data-tilt-max="5" data-tilt-speed="400" data-tilt-glare="true" data-tilt-max-glare="0.2" class="project-card lg:col-span-3 bg-gray-900/40 backdrop-blur-sm md:backdrop-blur-xl border border-gray-700/30 rounded-3xl overflow-hidden group hover:shadow-[0_0_40px_rgba(34,211,238,0.15)] transition-all duration-500 flex flex-col md:flex-row relative" data-aos="fade-up" data-aos-delay="600" data-category="uiux">
            <div class="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                ...
                <div class="flex flex-wrap gap-4 mt-2">
                    <a href="https://www.figma.com/design/JcJS7Unf8GujpPvVDLPEt4/QateringGo?node-id=0-1&t=Jo38w0YBiomUG441-1" target="_blank" rel="noopener noreferrer" class="px-6 py-3 bg-[#F24E1E] text-white rounded-full text-sm font-bold flex items-center gap-2 hover:scale-105 transition-transform shadow-[0_0_15px_rgba(242,78,30,0.4)]">
                        <svg class="parallax-img w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M8 2c-3.3 0-6 2.7-6 6s2.7 6 6 6v4c0 3.3 2.7 6 6 6s6-2.7 6-6v-4h-4v4c0 1.1-.9 2-2 2s-2-.9-2-2v-4h4v-8h-4V4c0-1.1-.9-2-2-2S8 1.1 8 2z"/></svg> Open Project in Figma
                    </a>
                </div>
            </div>
            <div class="md:w-1/2 bg-gray-800/50 relative overflow-hidden flex items-center justify-center p-8">
                ...
                <img loading="lazy" src="{{ asset('images/Perancangan Prototype User Interface (UI) Aplikasi Pemesanan Catering QateringGo Menggunakan Figma.png') }}" alt="QateringGo" class="parallax-img w-[85%] h-auto object-cover rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.6)] group-hover:scale-105 transition-transform duration-700 z-10">
            </div>
        </div>
        <!-- Project 7: QateringGo System Analyst (Span 3) -->
        <div data-tilt data-tilt-max="5" data-tilt-speed="400" data-tilt-glare="true" data-tilt-max-glare="0.2" class="project-card lg:col-span-3 bg-gray-900/40 backdrop-blur-sm md:backdrop-blur-xl border border-gray-700/30 rounded-3xl overflow-hidden group hover:shadow-[0_0_40px_rgba(34,211,238,0.15)] transition-all duration-500 flex flex-col md:flex-row relative" data-aos="fade-up" data-aos-delay="700" data-category="sa">
            <div class="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                ...
                <div class="flex flex-wrap gap-4 mt-2">
                    <a href="{{ asset('assets/docs/qateringgo-kertas-kerja-1.pdf') }}" target="_blank" class="px-6 py-3 bg-cyan-500/10 text-cyan-400 border border-cyan-500/30 rounded-full text-sm font-bold flex items-center gap-2 hover:bg-cyan-500/20 hover:scale-105 transition-all shadow-[0_0_15px_rgba(34,211,238,0.15)]">
                        <svg class="parallax-img w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg> Working Paper 1
                    </a>
                    <a href="{{ asset('assets/docs/qateringgo-kertas-kerja-2.pdf') }}" target="_blank" class="px-6 py-3 bg-indigo-500/10 text-indigo-400 border border-indigo-500/30 rounded-full text-sm font-bold flex items-center gap-2 hover:bg-indigo-500/20 hover:scale-105 transition-all shadow-[0_0_15px_rgba(99,102,241,0.15)]">
                        <svg class="parallax-img w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg> Working Paper 2
                    </a>
                </div>
            </div>
            <div class="md:w-1/2 bg-gray-800/50 relative overflow-hidden flex items-center justify-center p-8">
                ...
                <div class="parallax-img w-[80%] md:w-[60%] max-w-[280px] aspect-[3/4] bg-white border-4 md:border-[10px] border-black rounded-lg flex flex-col relative shadow-[0_10px_40px_rgba(0,0,0,0.6)] group-hover:scale-105 transition-transform duration-700 z-10 overflow-hidden my-4 mx-auto">
                    <!-- Folded Corner -->
                    ...
                    <!-- Red Banner -->
                    <div class="parallax-img w-[90%] bg-[#E00000] py-2 md:py-3 lg:py-5 self-center flex items-center justify-center z-10 border-black border-y-2 md:border-y-0">
        ...
        <div data-tilt data-tilt-max="5" data-tilt-speed="400" data-tilt-glare="true" data-tilt-max-glare="0.2" class="project-card lg:col-span-3 bg-gray-900/40 backdrop-blur-sm md:backdrop-blur-xl border border-gray-700/30 rounded-3xl overflow-hidden group hover:shadow-[0_0_40px_rgba(34,211,238,0.15)] transition-all duration-500 flex flex-col md:flex-row relative" data-aos="fade-up" data-aos-delay="800" data-category="web">
            <div class="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <div class="md:w-1/2 bg-gray-800/50 relative overflow-hidden flex items-center justify-center p-8">
                ...
                <!-- Project Image -->
                <img loading="lazy" src="{{ asset('images/toko-amira.png') }}" alt="Toko Amira Web" class="parallax-img w-[85%] h-auto object-cover rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.6)] group-hover:scale-105 transition-transform duration-700 z-10" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex'">
                
                <!-- Fallback Placeholder if Image Not Found -->
                <div style="display: none" class="parallax-img w-[85%] h-64 bg-gray-700/50 rounded-xl border border-gray-600/50 flex flex-col items-center justify-center text-gray-400 shadow-[0_10px_40px_rgba(0,0,0,0.6)] group-hover:scale-105 transition-transform duration-700 z-10">
                    <svg class="parallax-img w-16 h-16 mb-4 text-gray-500/50" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
